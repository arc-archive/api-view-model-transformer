...
declare namespace ApiElements {
  ...
  class ApiViewModelTransformer extends
     ...
     */
    computeViewModel(shape: any[]|object|null): Promise<any>|null;
     ...
     * the list.
     * @param result Result of model comupation. It's repoted by
     * the Promise.
     * @returns Promise resolved to thre view model.
     */
    _computeViewModelRecursive(items: any[]|null, result: any[]|null): Promise<any>|null;
     ...
     * for the data.
     *
     * @param model Model with `#link-target` property
     * @returns Resolved declaration or undefined.
     */
    _importLink(model: object|null): object|null|undefined;

    /**
     * Searches `_references` property for an id.
     *
     * @param id Declaration ID
     * @returns Model declaration or undefined if not found.
     */
    _searchDeclaration(id: String|null): object|null|undefined;
     ...
     * @returns Model declaration or undefined if not found.
     */
    _requestDeclaration(id: String|null): object|null|undefined;
